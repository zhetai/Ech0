...
func BuildHandlers(db *gorm.DB, cacheFactory *cache.CacheFactory, tmFactory *transaction.TransactionManagerFactory) (*Handlers, error) {
	...
	fediverseServiceInterface := service8.NewFediverseService(fediverseRepositoryInterface, userRepositoryInterface, settingServiceInterface, echoServiceInterface)
