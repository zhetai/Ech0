  ...
  <div class="rounded-md shadow-sm ring-1 ring-gray-200 ring-inset bg-white p-4 mb-3">
      ...
      <div class="w-full">
        ...
        <div class="flex flex-row items-center justify-start text-gray-500 h-10">
          <h2 class="font-semibold w-30 flex-shrink-0">启用S3:</h2>
        ...
        <!-- S3 Region -->
        <div v-if="S3Setting.provider === S3Provider.AWS" class="flex flex-row items-center justify-start text-gray-500 gap-2 h-10">
